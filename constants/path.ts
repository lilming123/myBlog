...
export const PATHS_MAP: Record<string, string> = {
  ...
  [PATHS.SITE_HOME]: "首页",
  [PATHS.SITE_BLOG]: "博客",
  [PATHS.SITE_SNIPPET]: "碎碎念",
  [PATHS.SITE_ABOUT]: "关于我",
  [PATHS.SITEMAP]: "站点地图",
  ...
  [PATHS.ADMIN_SNIPPET]: "碎碎念",
  [PATHS.ADMIN_SNIPPET_CREATE]: "创建碎碎念",
  [PATHS.ADMIN_SNIPPET_EDIT]: "编辑碎碎念",
  [PATHS.ADMIN_TAG]: "标签",
  [PATHS.ADMIN_NOTE]: "笔记",
...
export const PATH_DESCRIPTION_MAP: Record<string, string> = {
  ...
  [PATHS.SITE_SNIPPET]: "多是一些零零碎碎的碎碎念，通常是代码碎碎念",
  ...
  [PATHS.ADMIN_SNIPPET]: `碎碎念管理，在这里对碎碎念进行 增、删、改、查操作`,
